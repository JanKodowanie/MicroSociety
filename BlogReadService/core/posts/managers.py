...
class BlogPostCollectionManager:
    ...
    async def update_post(self, event: BlogPostUpdatedEvent):
        new_data = event.dict()
        update_model = BlogPostUpdateModel(**new_data)
    ...
    async def delete(self, event: BlogPostDeletedEvent):
